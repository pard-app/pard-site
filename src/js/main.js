    ...
    resources: {
      en: {
        translation: {
          ...
          feature_6_text: "We will pick up and deliver the item from your store to the customer while taking all the necessary precautions related to the COVID-19 epidemic.",
          meet: "Meet",
      ...
      lv: {
        translation: {
          ...
          feature_6_text: "Mēs nodrošināsim preču savākšanu no veikala un piegādi līdz klientam, ievērojot visas sanitārās prasības, kas saistītas ar COVID-19 epidēmiju.",
          meet: "Iepazīsties ar",
      ...
      lt: {
        translation: {
          ...
          intro_text: 'Programavimo kūrybinių dirbtuvių (angl. hackathon) „Hack the crisis" dalyviai, tarptautinė komanda #pard.app jungiasi prie verslumo skatinimo agentūros  „Versli Lietuva" pagalbos verslui iniciatyvos  „Internete karantino nėra" ir pristato e. prekybos vietą internete. Ši platforma yra skirta greitai ir patogiai susikurti savo profilį ir pradėti prekybą internete! O pirkėjams - tai viena vieta, kurioje galima rasti įvairius smulkaus ir vidutinio dydžio verslo siūlomus produktus! Atliekami baigiamieji platformos paleidimo darbai, todėl prekiauti ir atrasti naujus prekeivius galėsite jau labai greitai!',
          learn_more: "Sužinoti daugiau",
          early_access: "Noriu registruotis",
          features_title: "Esančios funkcijos",
          feature_1_title: "Į prekybą - iš karto",
          feature_1_text: "Užtenka minutės susikurti savo profilį šioje parduotuvėje, paprasta, kaip užsiregistruoti socialinėje platformoje",
          feature_2_title: "Jokio papildomo popierizmo",
          feature_2_text: "Pradėkite parduotuve naudotis iš karto, tiesiog privalote laikytis visų LR reikalavimų verslui šio karantino metu",
          feature_3_title: "Pridėti prekes ir tvarkyti sandėlį",
          feature_3_text: "Lengvai pridėkite prekes - nufotografuokite jas telefonu ir aprašykite, matysite užsakymus, vartotojai - sandėlio likutį",
          feature_4_title: "Pritraukite naujų lankytojų",
          feature_4_text: "Lankytojai naršo po parduotuvių profilius, ir gali daryti užsakymus tiesiai svetainėje.",
          feature_5_title: "Mokėjimas",
          feature_5_text: "Lankytojai gali daryti mokėjimus tiesiai svetainėje.",
          feature_6_title: "Prekių išdavimas ir pristatymas",
          feature_6_text: "Žmonės galės atvykti sanitariškai atsiimti prekių, o jūs galėsite rinktis iš pristatymo galimybių",
          meet: "Susipažinkime",
          meet_text: "Mes pradėjome kaip Hack-The-Crisis dalyviai, lauždami krizės kodą sukūrėme ir prisistatymą, peržiūrėkite video!",
          cta_title: "Domina? Registruokitės",
          cta_text: "Aplikacija šiuo metu kuriama, ir norintiems verslams siūlome kurtis profilius! Užsiregistruokite į mūsų susisiekimo paštą ir būkite pirmieji produkto naudotojai.",
